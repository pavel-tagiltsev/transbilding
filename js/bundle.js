...
function scrollAnimation() {
  ...
  if (animItems.length > 0) {
    ...
    animOnScroll(); // Fixed a bag with buttons

    for (let i = 0; i < animItems.length; i++) {
      if (animItems[i].getAttribute('href') == '#partners' || animItems[i].getAttribute('href') == '#certificates') {
...
function listToggle() {
  ...
  const list = document.querySelector(".main-nav__list"); // button.classList.remove("no--js");
...
/* harmony default export */ __webpack_exports__["default"] = (listToggle);
...
function fixedHeader() {
  ...
  window.addEventListener('scroll', function () {
    ...
    if (dY < 0) {
      header.classList.add('header-fixed'); // document.body.style.marginTop = `${header.clientHeight}px`;
    } else {
      header.classList.remove('header-fixed'); // document.body.style.marginTop = '0px';
    }
...
/* harmony default export */ __webpack_exports__["default"] = (fixedHeader); // Шапка липнет при скролле
...
/* harmony default export */ __webpack_exports__["default"] = (mapAnimation);
...
function pageNavigate() {
  ...
  function showUpButton() {
    if (window.pageYOffset + document.documentElement.clientHeight + 1000 >= document.documentElement.scrollHeight) {
...
/* harmony default export */ __webpack_exports__["default"] = (pageNavigate);
...
swiper__WEBPACK_IMPORTED_MODULE_5__.default.use([swiper__WEBPACK_IMPORTED_MODULE_6__.default]);

const Blazy = __webpack_require__(/*! blazy */ "./node_modules/blazy/blazy.js");

new Blazy({// Options
});
window.addEventListener("DOMContentLoaded", () => {
  (0,_modules_map__WEBPACK_IMPORTED_MODULE_1__.default)('#map');
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_5__.default('#swiper-other', {
    speed: 400,
    direction: 'horizontal',
    navigation: {
      nextEl: '.other__next',
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_5__.default('#swiper-certificates', {
    speed: 400,
    direction: 'horizontal',
    navigation: {
